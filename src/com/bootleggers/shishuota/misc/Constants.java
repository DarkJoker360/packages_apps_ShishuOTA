 ...
 */
package com.bootleggers.shishuota.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_DATE = "ro.bootleggers.build.date";
    public static final String PROP_BUILD_VERSION = "ro.bootleggers.version";
    public static final String PROP_BUILD_VERSION_NUMBER = "ro.bootleggers.version_number";
    ...
    public static final String PROP_UPDATER_URI = "bootleggers.updater.uri";
